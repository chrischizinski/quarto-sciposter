...
format:
  sciposter-typst:
    ...
    poster:
      ...
      title-gaps:
        author: "0.22in"
      # Same for the type sizes under the title. The byline defaults to a
      # ratio of the BODY size, so this is the only way to lift it without
      # resizing the whole poster.
      title-sizes:
        author: "40pt"
...
## A centred subheading

`subheading-align: center` centres level-2 subheadings, the way
`heading-align` does for the level-1 bars above. Both default to `left`.
